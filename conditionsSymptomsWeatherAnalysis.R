...
# Date; 02/17/18
# Objective: look at different condiitons and flares as they are affected by weather
...
# fd <- fd[trackable_name %in& c("migraine", "headache","head ache","rheumatoid arthritis", "pressure")]
...
# Cut the data differently to use bins ------------------------------------
